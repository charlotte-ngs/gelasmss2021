...
The file `r s_lasso_data_path` contains a dataset with genotypes from `r n_nr_snp` SNP-Loci. In addition to that the dataset also has observations of a certain trait for `r n_nr_ani` animals. The dataset can be read into a matrix with the following statement.

```{r data-scan-stmt, echo=FALSE, results='markup'}
