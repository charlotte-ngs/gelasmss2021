...
n_id_sire <- 6
n_id_dam <- 9
# course url used for defining paths to data files
...
Because the four offspring $22$, $23$, $24$ and $25$ do not have any phenotypic observations, the vector $y$ and the design matrix $X$ do not changed compared to the solution of Problem 1 in Exercise 4. Because there are four offspring animals added to the pedigree, the vector $u$ of all breeding values and with that the matrices $Z$ and $A$ have to be changed. 
...
```{r, message=FALSE}
s_ped_ext_path <- file.path(s_course_url, "data", "data_ex05_p01_ped.csv")
...
s_gen_path <- file.path(s_course_url, "data", "data_ex05_p02_gen.csv")
