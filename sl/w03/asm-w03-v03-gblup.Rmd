...
```{r selectsnploci, echo=FALSE, hook_convert_odg=TRUE, fig_path="odg", out.width='12cm'}
...
```{r forwardselection, echo=FALSE, hook_convert_odg=TRUE, fig_path="odg", out.width='11cm'}
...
```{r backwardelimination, echo=FALSE, hook_convert_odg=TRUE, fig_path="odg", out.width='11cm'}
...
```{r memvsbvm, echo=FALSE, hook_convert_odg=TRUE, fig_path="odg", out.width='12cm'}
