...
## Performance Testing
```{r performancetest, echo=FALSE, hook_convert_odg=TRUE, fig_path="odg", out.width='11cm'}
...
```{r gstest, echo=FALSE, hook_convert_odg=TRUE, fig_path="odg", out.width='11cm'}
...
```{r twostepapproachfigure, echo=FALSE, hook_convert_odg=TRUE, fig_path="odg", out.width='11cm'}
