...
## Data
```{r datastucturegbv, echo=FALSE, hook_convert_odg=TRUE, fig_path="odg", out.width='11cm'}
...
```{r geneticmodeldiagram, echo=FALSE, hook_convert_odg=TRUE, fig_path="odg", out.width='11cm'}
...
## LSQ Diagram
```{r showregressionbwonbc, echo=FALSE, hook_convert_odg=TRUE, fig_path="odg", out.width='11cm'}
...
$$\frac{\partial LS}{\partial \hat{b}} = -X^Ty - X^Ty + 2X^TX\hat{b} = 0$$
...
```{r snp-data-linkage, echo=FALSE, hook_convert_odg=TRUE, fig_path="odg", out.width='11cm'}
...
```{r snp-data-dummy-reg-line, echo=FALSE, hook_convert_odg=TRUE, fig_path="odg", out.width='11cm'}
