...
Welcome to the lecture "Applied Genetic Evaluation of Livestock".

During this lecture which starts today and lasts until the end of the semester, we look into the broader context of Applied Genetic Evaluation of Livestock and into some selected topics of Genetic Evaluations.

As we will see in a minute, applied genetic evaluation is a very special aspect in the broader context of breeding programs and breeding organisation.
}
...
This table shows the tentative schedule. The sequence of topics is determined by the process that is run when a new trait is to be included into a breeding program. Examples of traits for which we did this described procedure are 

\begin{itemize}
\item calf survival (introduced in April 2020)
\item twin and multiple birth (no decision about introduction, master thesis of Sarah Widmer)
\end{itemize}
...
The goal of this course is to understand how the tools of livestock breeding work and what they are useful for and what they cannot do. 

It is important to understand the difference between breeding and production.
