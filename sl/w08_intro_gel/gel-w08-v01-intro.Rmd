...
dCourseStart <- as.Date("2021/04/12")
...
# subjects per week
Topic[1] <- "Introduction to Genetic Evaluation of Livestock"
Topic[2] <- "Model Selection"
Topic[3] <- "Variance Components"
Topic[4] <- "Genetic Groups and Longitudinal Data"
Topic[5] <- "Genomic Selection"
Topic[6] <- "Questions, Test Exam"
Topic[7] <- "__Pfingstmontag__"
Topic[8] <- "Exams" 
