...
tbl_add_nb <- tibble::tibble(Week = c(4),
                     Date = c("2021-03-15"),
                     Topic = c(paste0("[Fixed Linear Effect Models with Genomic Data](", s_misc_url, "20210315_flem_problem_genomic_data.nb.html)", collapse = '')))
...
tbl_sl <- tibble::tibble(Week    = c(1, 2, 3, 4, 5),
                         Date    = c("2021-02-22",
                                     "2021-03-01",
                                     "2021-03-08",
                                     "2021-03-15",
                         ...
                         Link    = c(
                           ...
                           paste0("[original](", s_sl_url, "asm-w04-v04-grm.pdf)", collapse = ''), 
                           paste0("[original](", s_sl_url, "asm-w05-v05-lasso.pdf)", collapse = '')
                         ))
knitr::kable(tbl_sl)
```
...
```{r, echo=FALSE}
tbl_video <- tibble::tibble(Week = c(1, 2, 3, 4),
                            Date = c("2021-02-22",
                                     "2021-03-01",
                                     "2021-03-08", 
                                     "2021-03-15"),
