...
where $y$ is a vector of length $N$ of observations, $b$ is an unknown vector of length $p$ of fixed effects, $u$ is an unknown vector of length $q$ of random breeding values and $e$ is an unknown vector of length $N$ of random error terms. The matrices $X$ and $Z$ are known design matrices linking the corresponding effects to the observations. As part of the model specification, the variances of the random effects are defined as 
